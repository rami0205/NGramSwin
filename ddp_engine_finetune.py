...
# Super-Resolution
def train_one_epoch(gpu, rank, model, data_loader, optimizer, loss_scaler, criterion, epoch, warm_start, args):
    ...
    for data_iter, (img_hr, img_lr) in enumerate(tqdm(data_loader)):
        ...
        if data_iter%args.accum_iter==0:
            if args.lrd=='cosine':
                ...
                half_learning_rate(optimizer, epoch + data_iter/len(data_loader), args, warm_start)
